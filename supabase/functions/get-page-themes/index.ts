// Edge Function: get-page-themes
// Fonte: .dev/specs/aggregated-metrics/edge-functions-per-page.md
//
// Página "Pautas Eleitorais" (`/themes`,
// intelligence-center/electoral-themes.md). Aceita `pauta_id` opcional no
// corpo — quando presente, escopa `narratives`/`breakdowns` à Pauta
// selecionada ("narrativas dentro da pauta"); ausente, mostra a lista
// completa de Pautas (Narrativas de topo).
//
