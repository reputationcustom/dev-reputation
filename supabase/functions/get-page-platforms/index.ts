// Edge Function: get-page-platforms
// Fonte: .dev/specs/aggregated-metrics/edge-functions-per-page.md
//
// Página "Análise por Plataforma" (`/platforms`,
// intelligence-center/platform-analysis.md).
//
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const envelope = await assemblePageResponse(supabase, 'platforms', {
      organizationId,
      period,
