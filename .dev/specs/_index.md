...
| `entities`              | Cadastro Nacional de Entidades (EAV via entity_tags) + vínculo com o ranking de Autores e Influenciadores | **pronto** (especificado 2026-07-13; `data-model.md` **implementado** o mesmo dia — schema + seed real de 21 partidos/593 parlamentares federais + contas de rede social de 512 deputados (não os 81 senadores, sem fonte oficial), migrations `20260731000000`/`20260731010000`/`20260731030000` — CRUD e vínculo com Autores ainda não implementados, ver `CLAUDE.md`) | 2      | [entities/overview.md](entities/overview.md) |
